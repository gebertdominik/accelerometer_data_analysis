...
# print('Dummy Classifier        ', sig.test_and_learn_dummy_cls(features_person_1_2_3, features_person_4))
...
print('GaussianNB              ', sig.test_and_learn_mlp_cls(features_person_1_2_3, features_person_4))

"""print('\nTest Classifiers - learn: 1,2,4 test: 3')
print('Dummy Classifier        ', sig.test_and_learn_dummy_cls(features_person_1_2_4, features_person_3))
...
print('GaussianNB              ', sig.test_and_learn_mlp_cls(features_person_1_2_4, features_person_3))

print('\nTest Classifiers - learn: 1,3,4 test: 2')
print('Dummy Classifier        ', sig.test_and_learn_dummy_cls(features_person_1_3_4, features_person_2))
...
print('GaussianNB              ', sig.test_and_learn_mlp_cls(features_person_1_3_4, features_person_2))

print('\nTest Classifiers - learn: 2,3,4 test: 1')
print('Dummy Classifier        ', sig.test_and_learn_dummy_cls(features_person_2_3_4, features_person_1))
...
print('GaussianNB              ', sig.test_and_learn_mlp_cls(features_person_2_3_4, features_person_1))"""
